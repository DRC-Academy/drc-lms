...
export default function Banner({
  ...
  if (esBarra) {
    return (
      <div data-barra-inferior className="pointer-events-none fixed inset-x-0 bottom-[calc(86px+env(safe-area-inset-bottom))] z-30 px-4 min-[900px]:bottom-6 min-[900px]:px-9">
