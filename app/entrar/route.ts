...
// ese email es del equipo o de un alumno, y se cambia el token de 15
// minutos por la cookie de 30 días. El rol se decide AQUÍ, en el
// servidor, a partir del email firmado. Nada de lo que traiga la URL
// más allá del token entra en la decisión.
//
...
export async function GET(peticion: NextRequest) {
  ...
  return entrarComo(peticion.url, sesion);
}
