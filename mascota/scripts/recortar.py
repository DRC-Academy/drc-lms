...
(mascota/scripts/py.js), que es lo que llama el script npm.
"""
...
def main() -> int:
    ...
    parser.add_argument("--solo-contacto", action="store_true", help="solo rehacer contacto.png con los PNG que ya hay")
